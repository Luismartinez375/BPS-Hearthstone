...
export default function HearthScroll({ list, funct }: HearthScrollProps) {
  ...
  return (
    <div className=" bg-gradient-to-b from-gold via-gold_2 via-80% to-gold_3 h-auto p-0.5 z-10 w-56 max-sm:hidden lg:absolute lg:top-[27%] xl:top-1/4 rounded-xl flex flex-col items-center">
      <div
